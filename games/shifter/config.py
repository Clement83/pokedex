...
CARS = [
    ...
    },
    {
        ...
        "col":   (175, 12, 12),
        "acc":   (255, 80, 80),
        "sprite": {"sheet": "vehicle1.png", "x": 0,   "y": 341, "w": 768, "h": 341},
        "hud":   "retro",
    ...
    },
    {
        ...
        "col":   (208, 208, 213),
        "acc":   (255, 255, 255),
        "sprite": {"sheet": "vehicle1.png", "x": 768, "y": 341, "w": 768, "h": 341},
        "hud":   "ghost",
    ...
    },
    {
        ...
        "col":   (120, 40, 180),
        "acc":   (200, 100, 255),
        "sprite": {"sheet": "vehicle1.png", "x": 0,   "y": 682, "w": 768, "h": 341},
        "hud":   "race",
    ...
    },
    {
        ...
        "col":   (18, 48, 200),
        "acc":   (80, 160, 255),
        "sprite": {"sheet": "vehicle1.png", "x": 768, "y": 682, "w": 768, "h": 341},
        "hud":   "street",
    ...
    # ── vehicle2.png – JDM iconiques tuné (480–520 ch) ───────────────────────
    {
        ...
        "ratios": [3.4, 2.1, 1.55, 1.18, 0.92, 0.75],
    },
    {
        "name":  "Skyline R34",
        "cat":   "JDM",
        ...
        "ratios": [3.5, 2.2, 1.6, 1.2, 0.94, 0.78],
    },
    {
        "name":  "Accord Euro R",
        "cat":   "JDM",
        ...
        "col":   (60, 160, 10),
        "acc":   (140, 240, 60),
        "sprite": {"sheet": "vehicle2.png", "x": 0,   "y": 341, "w": 768, "h": 341},
        "hud":   "rally",
        ...
        "ratios": [3.7, 2.3, 1.65, 1.25, 0.98, 0.82],
    },
    {
        "name":  "RX-8 Spirit R",
        "cat":   "JDM",
        ...
        "col":   (25, 80, 200),
        "acc":   (80, 160, 255),
        "sprite": {"sheet": "vehicle2.png", "x": 768, "y": 341, "w": 768, "h": 341},
        "hud":   "race",
        ...
        "ratios": [3.9, 2.4, 1.72, 1.3, 1.02, 0.84],
    },
    {
        "name":  "Eclipse GTS",
        "cat":   "JDM",
        ...
        "col":   (200, 175, 0),
        "acc":   (255, 230, 50),
        "sprite": {"sheet": "vehicle2.png", "x": 0,   "y": 682, "w": 768, "h": 341},
        "hud":   "retro",
    ...
    },
    {
        ...
        "col":   (215, 215, 225),
        "acc":   (255, 200, 220),
        "sprite": {"sheet": "vehicle2.png", "x": 768, "y": 682, "w": 768, "h": 341},
        "hud":   "street",
        ...
        "ratios": [3.8, 2.35, 1.68, 1.28, 1.0, 0.83],
    },
    ...
    },
    {
        ...
        "ratios": [3.5, 2.15, 1.56, 1.17, 0.92, 0.77],
    },
    {
        "name":  "Challenger R/T",
        "cat":   "MUSCLE",
        ...
        "col":   (40, 130, 20),
        "acc":   (100, 230, 50),
        "sprite": {"sheet": "vehicle3.png", "x": 0,   "y": 341, "w": 768, "h": 341},
        "hud":   "retro",
        ...
        "ratios": [3.1, 1.95, 1.42, 1.08, 0.86, 0.70],
    },
    {
        ...
        "col":   (35, 35, 35),
        "acc":   (200, 165, 50),
        "sprite": {"sheet": "vehicle3.png", "x": 768, "y": 341, "w": 768, "h": 341},
        "hud":   "rally",
        ...
        "ratios": [3.6, 2.2, 1.6, 1.22, 0.96, 0.80],
    },
    {
        "name":  "Barracuda 440",
        "cat":   "MUSCLE",
        ...
        "col":   (200, 80, 10),
        "acc":   (255, 140, 40),
        "sprite": {"sheet": "vehicle3.png", "x": 0,   "y": 682, "w": 768, "h": 341},
        "hud":   "retro",
    ...
    },
    {
        ...
        "col":   (155, 160, 165),
        "acc":   (210, 220, 230),
        "sprite": {"sheet": "vehicle3.png", "x": 768, "y": 682, "w": 768, "h": 341},
        "hud":   "sport",
        ...
        "ratios": [3.3, 2.05, 1.50, 1.14, 0.90, 0.73],
    },
]
