"""Script temporaire : écrit le nouveau loop.py."""
            ...
            for i, player in enumerate(players):
                ...
                if craft_menus[i].visible:
                    ...
                    if cur_mine and not prev_mine[i]:
                        ...
                        msg  = (f"Craft\\u00e9 : {name} !" if name else "Ressources insuffisantes")
...
# Supprimer l'indentation du texte dedent (4 espaces)
# Le contenu utilise une indentation de 4 espaces pour le module, donc on est bons.

dest = pathlib.Path(__file__).parent / "loop.py"
dest.write_text(NEW_CONTENT, encoding="utf-8")
lines = NEW_CONTENT.count("\n")
print(f"loop.py écrit : {lines} lignes")
